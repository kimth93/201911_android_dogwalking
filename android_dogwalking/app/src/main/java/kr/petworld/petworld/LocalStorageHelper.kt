...
class LocalStorageHelper : DocumentsProvider() {

    @Throws(FileNotFoundException::class)
    override fun queryRoots(projection: Array<String>?): Cursor {
        // 요청된 필드 값이나 기본 값으로 커서 만듬
        ...
        row.add(
            ...
            Objects.requireNonNull<Context>(context).getString(R.string.internal_storage)
        )
        row.add(
    ...
    override fun createDocument(
        ...
        try {
            ...
            Log.e(LocalStorageHelper::class.java.simpleName, "Error creating new file $newFile")
        }
    ...
    override fun openDocumentThumbnail(
        ...
        try {
            ...
            Log.e(LocalStorageHelper::class.java.simpleName, "Error writing thumbnail", e)
            return null
        } finally {
            if (out != null)
                try {
                    ...
                    Log.e(LocalStorageHelper::class.java.simpleName, "Error closing thumbnail", e)
                }
    ...
    companion object {
        ...
        val AUTHORITY = "spartons.com.amazons3fileuploadtesting"
